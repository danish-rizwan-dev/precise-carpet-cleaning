...
export default function Hero() {
  ...
  return (
    <div ref={heroRef} className="relative w-full overflow-hidden bg-black font-['Plus_Jakarta_Sans',sans-serif]">
      ...
      {/* Features Strip */}
      <section className="relative z-10 bg-[#fff] px-5 pb-10 pt-5 sm:px-8 sm:pb-14 sm:pt-7 md:px-14">
